...
var SelectPair = function(params)
{
    ...
    var that            = this,
        ...
        $_parent_div    = $("<div />")      .addClass("SelectPair"),
        $_select_anchor = $("<a />")        .addClass("SelectPair_anchor")     .text( select_name ),
        $_search        = $("<input />")    .addClass("SelectPair_search"),
        $_submit        = $("<input />")    .addClass("SelectPair_submit")     .val("Apply") .attr('type','submit') .data("selected", ""),
        $_dropdown_div  = $("<div />")      .addClass("SelectPair_dropdown"),
        ...
        {
            var uID             = 'SelectPair_' + select_name + "_" + name.replace(" ", "_"),
                $_li            = $("<li />"),
